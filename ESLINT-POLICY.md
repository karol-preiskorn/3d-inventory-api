...
This project enforces a **ZERO TOLERANCE** policy for ESLint errors. **No

  commits are allowed when ESLint errors exist anywhere in the codebase.**
...
**Solution**: Reorganize imports according to groups, remove empty lines between
  groups
...
**Solution**: Check if ESLint is processing large files, wait or use Ctrl+C and
  fix errors manually
...
**The result is a professional, maintainable codebase that the entire team can
  be proud of! 🚀**

...
export function validateDeviceInput(data: Partial<CreateDeviceRequest>): { isValid: boolean; error?: string } {
  ...
  if (position.x < DEVICE_VALIDATION.POSITION_MIN || position.x > DEVICE_VALIDATION.POSITION_MAX ||
    position.y < DEVICE_VALIDATION.POSITION_MIN || position.y > DEVICE_VALIDATION.POSITION_MAX ||
    position.h < DEVICE_VALIDATION.POSITION_MIN || position.h > DEVICE_VALIDATION.POSITION_MAX) {

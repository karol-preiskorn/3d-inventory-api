...
var logger = (0, logger_1.default)('attributesDictionary');
...
router.get('/:id', (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var client, db, collection, query, result, error_1, errorMessage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 4:
                ...
                logger.error("GET /".concat(collectionName, "/").concat(req.params.id, " - error: ").concat(errorMessage));
...
router.put('/:id', (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, filter, _a, componentName, type, name, unit, updateFields, updates, client, db, collection, result, error_2, errorMessage;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
                if (!mongodb_1.ObjectId.isValid(id)) {
                    logger.error("PUT /".concat(collectionName, "/").concat(id, " - invalid _id"));
                    return [2 /*return*/, res.sendStatus(400)];
                }
                filter = { _id: new mongodb_1.ObjectId(id) };
                _a = req.body, componentName = _a.componentName, type = _a.type, name = _a.name, unit = _a.unit;
                updateFields = {};
                if (componentName !== undefined)
                    updateFields.componentName = componentName;
                if (type !== undefined)
                ...
                if (Object.keys(updateFields).length === 0) {
                    logger.warn("PUT /".concat(collectionName, "/").concat(id, " - no fields to update"));
            ...
            case 3:
                ...
                if (result.matchedCount === 0) {
                    logger.warn("PUT /".concat(collectionName, "/").concat(id, " - not found"));
                    return [2 /*return*/, res.status(404).json({ message: 'Not found' })];
                }
                logger.info("PUT /".concat(collectionName, "/").concat(id, " - updated"));
                res.status(200).json(result);
                return [3 /*break*/, 7];
            case 4:
                error_2 = _b.sent();
                errorMessage = error_2 instanceof Error ? error_2.message : 'Unknown error';
                logger.error("PUT /".concat(collectionName, "/").concat(id, " - error: ").concat(errorMessage));
                res.status(500).json({ message: 'Internal Server Error' });
                return [3 /*break*/, 7];
            case 5: return [4 /*yield*/, (0, db_1.closeConnection)(client)];
            case 6:

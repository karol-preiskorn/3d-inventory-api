    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                results = _a.sent();
                if (!results) {
                    logger_js_1.logger.warn('GET /models - not found');
                    res.status(404).send('Not found');
                }
                else {
                    logger_js_1.logger.info('GET /models - oki return ' + results.length + ' models');
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                client = _a.sent();
                db = (0, dbUtils_js_1.connectToDb)(client);
                collection = db.collection(collectionName) // Remove the explicit type annotation for 'collection'
                ;

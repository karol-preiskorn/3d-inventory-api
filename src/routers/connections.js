    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, collection.find({}).limit(256).toArray()];
            case 2:
                results = _a.sent();
...
router.put('/:id', (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var query, c, updates, client, db, collection, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!mongodb_1.ObjectId.isValid(req.params.id)) {
            ...
            case 2:
                result = _a.sent();
                res.status(200).json((0, mongo_sanitize_1.default)(result)).send('Not found devices to update');
                res.status(200).json(result);
                return [4 /*yield*/, (0, dbUtils_js_1.connectionClose)(client)];
            case 3:
                _a.sent();

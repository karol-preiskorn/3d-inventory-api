 ...
 */
function CreateLog(objectId, message, operation, component) {
    return __awaiter(this, void 0, void 0, function () {
        var client, db, collection, log, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    log = {
                        date: (0, date_fns_1.format)(new Date(), 'yyyy-MM-dd HH:mm:ss'),
                        message: message,
                        operation: operation,
                        component: component,
                        objectId: objectId,
                    ...
                    return [4 /*yield*/, collection.insertOne(log)]; // Replace 'collection' with the correct collection name
                case 2:
                    result = _a.sent() // Replace 'collection' with the correct collection name
                    ;
                    return [2 /*return*/, (0, rxjs_1.of)(result)];
            }
        });
    });
}

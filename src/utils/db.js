...
var logger = (0, logger_1.default)('db');
var uri = config_1.default.ATLAS_URI;
/**
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    logger.error("Connection to Atlas cluster failed: ".concat(error_1));
                    process.exit(1);
                    return [3 /*break*/, 3];
...
function connectToDb(client) {
    if (!config_1.default.DBNAME || typeof config_1.default.DBNAME !== 'string') {
        throw new Error('Invalid or undefined DBNAME in configuration.');
    }
    try {
        var db = client.db(config_1.default.DBNAME);
        logger.info("Successfully connected to Atlas DB ".concat(config_1.default.DBNAME));
        return db;
    }
    catch (error) {
        logger.error("Connection to Atlas DB failed (".concat(config_1.default.DBNAME, "): ").concat(error));
        process.exit(1);
    }
}
/**
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_2 = _a.sent();
                    logger.error("Failed to close MongoDB connection: ".concat(error_2));
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });

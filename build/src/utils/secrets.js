...
if (fs_1.default.existsSync(".env")) {
    ...
    logger_1.default.error("Use .env.example file to setup config environment variables");
    dotenv_1.default.config({ path: ".env.example" }); // you can delete this after you create your own .env file!
}
exports.ENVIRONMENT = process.env.MONGO_ENV;
const prod = exports.ENVIRONMENT === "Atlas"; // Anything else is treated as 'dev'
